<header class="app-header">
  <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="d-block d-lg-none">
          <img src="{{ asset('front/assets/images/logo.png') }}" class="dark-logo" width="120" alt="" />
          <img src="{{ asset('front/assets/images/logo-light.png') }}" class="light-logo" width="120" alt="" />
      </div>
                      ...
                      <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
                          <div class="profile-dropdown position-relative" data-simplebar>
                              ...
                              <div class="d-grid py-4 px-7 pt-8">
                                  <a href="{{ url('admin/logout') }}" class="btn btn-danger">Log Out</a>
                              </div>
                          </div>
                      </div>
                  </li>
